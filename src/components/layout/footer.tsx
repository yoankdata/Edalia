...
export function Footer() {
  ...
  const COLOR_BG_DARK = 'bg-[#1F2937]'; // fond anthracite
  const COLOR_ACCENT = '#6BBD78'; // vert clair
  const COLOR_BORDER = 'border-white/10';

  return (
    <footer
      className={`${COLOR_BG_DARK} !text-white mt-24 shadow-2xl shadow-black/30`}
    >
      <div className="container mx-auto px-4 py-10 md:px-6 md:py-14">
        ...
        <div className="grid gap-10 md:gap-12 lg:gap-16 md:grid-cols-[minmax(0,1.4fr)_minmax(0,2fr)] items-start">
          ...
          <div className="space-y-4">
            ...
            <div
              className={`inline-flex items-center gap-2 rounded-full ${COLOR_BORDER} border bg-white/5 px-3 py-1 mt-2`}
            >
        ...
        {/* Bottom */}
        <div
          className={`mt-10 border-t ${COLOR_BORDER} pt-5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-white/50`}
        >
          <p className="text-white/50">
            &copy; {currentYear} Kademya Abidjan. Tous droits réservés.
          </p>
