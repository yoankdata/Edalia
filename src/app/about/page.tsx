    ...
    <div className="bg-background overflow-hidden">
        ...
        */}
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-10">
            Plus qu&apos;une plateforme, Kademya est le pont de confiance entre des professeurs talentueux et des élèves ambitieux.
          </p>
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border border-white/10 aspect-[4/3] rotate-1 hover:rotate-0 transition-transform duration-500">
              {aboutImage ? (
                <Image
                  ...
                  alt="Fondateurs d'Kademya travaillant ensemble"
                  fill
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                ...
                <p className="font-medium text-foreground border-l-4 border-primary pl-4">
                  Nous avons créé Kademya pour combler ce vide : une plateforme transparente, humaine et sécurisée.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container px-4 mx-auto max-w-4xl">
          <div className="space-y-6 text-center mb-10">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
              Nous avons choisi un modèle clair, qui protège à la fois les familles et les professeurs&nbsp;:
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <Card className="bg-card/70 backdrop-blur-sm border border-border/60">
              <CardContent className="p-6 space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  L&apos;inscription est <span className="font-semibold text-foreground">100% gratuite</span>. 
                  Pour être visible dans le catalogue Kademya, le professeur souscrit à un abonnement simple de{' '}
            ...
            <Card className="bg-card/70 backdrop-blur-sm border border-border/60">
              <CardContent className="p-6 space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Kademya ne prend <span className="font-semibold text-foreground">aucune commission</span> 
                  sur les cours. Les parents paient directement le professeur (Mobile Money, espèces, virement…).
                  La plateforme sert de vitrine et de filtre de confiance.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/70 backdrop-blur-sm border border-border/60">
              <CardContent className="p-6 space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Notre rôle est de rendre les professeurs visibles, rassurer les parents 
                  et structurer le marché. Pas de frais cachés, pas de pourcentage sur le travail 
                  des enseignants : seulement un abonnement mensuel pour la visibilité.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <a
                  href="mailto:contact@Kademya.ci"
                  className="flex items-center p-4 bg-background rounded-xl border hover:border-primary transition-colors group"
                >
                  ...
                  <div>
                    ...
                    <p className="font-semibold">contact.kademya@gmail.com</p>
                  </div>
                </a>
      ...
      <section className="py-20 bg-gradient-to-b from-primary/5 to-background px-4 relative overflow-hidden border-t border-border/40">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-foreground leading-snug">
            Prêt à faire évoluer l&apos;éducation à Abidjan&nbsp;?
          </h2>

          <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto">
            Trouvez un enseignant vérifié ou créez votre profil en quelques minutes.  
            Avec Kademya, parents et professeurs gagnent en confiance et en simplicité.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Button
              ...
              asChild
            >
              <a href="/become-a-teacher">Devenir professeur</a>
            </Button>
          </div>
        </div>
      </section>
